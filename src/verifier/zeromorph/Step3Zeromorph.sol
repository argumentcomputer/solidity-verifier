...
library Step3GrumpkinZeromorphLib {
    ...
    function compute_tau_primary(
        ...
        transcript = KeccakTranscriptLib.absorb(transcript, label, computed_digest);
        ...
        if (useLogging) {
            ...
            console.logBytes32(bytes32(computed_digest));
