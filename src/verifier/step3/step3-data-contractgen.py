...
primary_data_function_def += "\t\treturns (uint256, uint256[] memory, uint256, uint256, uint256[] memory, uint256, uint256, uint256[] memory)\n"
...
secondary_data_function_def += "\t\treturns (uint256, uint256[] memory, uint256, uint256, uint256[] memory, uint256, uint256, uint256[] memory)\n"
