...
PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + parsedProof.l_u_secondary_comm_W_comm
PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + "%0.64X" % len(l_u_secondary_X)
for item in l_u_secondary_X:
    PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + item

PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + parsedProof.r_u_primary_comm_W_comm
PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + parsedProof.r_u_primary_comm_E_comm
PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + "%0.64X" % len(r_u_primary_X)
for item in r_u_primary_X:
    PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + item

PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + r_u_primary_u

PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + parsedProof.r_u_secondary_comm_W_comm
PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + parsedProof.r_u_secondary_comm_E_comm
PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + "%0.64X" % len(r_u_secondary_X)
for item in r_u_secondary_X:
    PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + item

PROOF_BYTE_STREAM = PROOF_BYTE_STREAM + r_u_secondary_u

# STEP 2

print(PROOF_BYTE_STREAM)