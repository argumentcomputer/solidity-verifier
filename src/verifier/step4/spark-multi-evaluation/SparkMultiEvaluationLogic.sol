...
import "src/verifier/step4/spark-multi-evaluation/SparkMultiEvaluationDataPrimary.sol";
import "src/verifier/step4/spark-multi-evaluation/SparkMultiEvaluationDataSecondary.sol";
...
library SparkMultiEvaluationLib {
    function multiEvaluateSecondaryInner(R1CSShapeLibSecondary.Triple[] memory input, uint256[] memory T_x, uint256[] memory T_y) private pure returns (uint256) {
    ...
    function multiEvaluatePrimaryInner(R1CSShapeLibPrimary.Triple[] memory input, uint256[] memory T_x, uint256[] memory T_y) private pure returns (uint256) {
    ...
    function multiEvaluateSecondary(uint256[] memory r_x, uint256[] memory r_y) public pure returns (uint256, uint256, uint256){
    ...
    function multiEvaluatePrimary(uint256[] memory r_x, uint256[] memory r_y) public pure returns (uint256, uint256, uint256){
