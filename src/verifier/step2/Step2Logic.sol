...
library NovaVerifierStep2Lib {
    ...
    function verifySecondary(PoseidonConstants.Pallas memory constants, NovaVerifierStep2DataLib.CompressedSnarkStep2Secondary memory proofDataStep2Secondary, NovaVerifierStep2DataLib.VerifierKeyStep2 memory vkStep2, uint32 numSteps, uint256[] memory z0_secondary) public {
    ...
    function verifyPrimary(PoseidonConstants.Vesta memory constants, NovaVerifierStep2DataLib.CompressedSnarkStep2Primary memory proofDataStep2Primary, NovaVerifierStep2DataLib.VerifierKeyStep2 memory vkStep2, uint32 numSteps, uint256[] memory z0_primary) public {
        // Compare first 25 mix / arc Poseidon constants from verifier key with expected ones
