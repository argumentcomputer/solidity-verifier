...
contract NovaVerifierContractTest is Test {
    function testVerificationStep1() public pure {
        NovaVerifierStep1Lib.VerifierKeyStep1
            memory verifierKeyStep1 = NovaVerifierStep1Lib
                .loadVerifierKeyStep1();

        uint256[] memory r_u_primary_X = NovaVerifierStep1DataLib
            .get_r_u_primary_X();

        uint256[] memory l_u_primary_X = NovaVerifierStep1DataLib
            .get_l_u_primary_X();

        uint256[] memory r_u_secondary_X = NovaVerifierStep1DataLib
            .get_r_u_secondary_X();

        uint256[] memory l_u_secondary_X = NovaVerifierStep1DataLib
            .get_l_u_secondary_X();

        NovaVerifierStep1Lib.CompressedSnarkStep1
            memory proofDataStep1 = NovaVerifierStep1Lib
                .loadCompressedSnarkStep1(
                    l_u_primary_X,
                    l_u_secondary_X,
                    r_u_primary_X,
                    r_u_secondary_X
    ...
    function testVerificationStep2() public view {
        ...
        NovaVerifierStep2DataLib.CompressedSnarkStep2Primary
            memory proofDataPrimary = NovaVerifierStep2DataLib
                .getCompressedSnarkStep2Primary();
        NovaVerifierStep2DataLib.CompressedSnarkStep2Secondary
            memory proofDataSecondary = NovaVerifierStep2DataLib
                .getCompressedSnarkStep2Secondary();
        NovaVerifierStep2DataLib.VerifierKeyStep2
            memory vk = NovaVerifierStep2DataLib.getVerifierKeyStep2();
        (
            PoseidonConstants.Pallas memory pallasConstants,
            PoseidonConstants.Vesta memory vestaConstants
        ) = PoseidonConstants.getPoseidonConstantsForBasicComparison();

        NovaVerifierStep2Lib.verifyPrimary(
            vestaConstants,
            proofDataPrimary,
            vk,
            numSteps,
        ...
        NovaVerifierStep2Lib.verifySecondary(
            pallasConstants,
            proofDataSecondary,
            vk,
            numSteps,
    ...
    function testPrimaryVerificationStep4SubStep2() public pure {
        ...
        tau[
            0
        ] = 0x327f4af4db96711d3192cee19b1946d5b9d3c61e78d6f352261e11af7cbed55a;
        tau[
            1
        ] = 0x2640290b59a25f849e020cb1b0063861e35a95a8c42a9cdd63928a4ea856adbf;
        tau[
            2
        ] = 0x11b72e2a69592c5545a794428674fd998d4e3fbd52f156eca4a66d54f09f775e;
        tau[
            3
        ] = 0x09b0dcdd3ebe153fea39180a0f6bf9546778ffd7e288088489529aa95097fcea;
        tau[
            4
        ] = 0x3757c49e53ce7f58203159e411db2fe38854df4fc7a93833f28e63960576202e;
        tau[
            5
        ] = 0x362681bac77a734c4b893a2a2ff2f3cfbff469319b1a1e851c139349f1f62232;
        tau[
            6
        ] = 0x3036e71d56b2ed7027b5e305dddbc94d3bae6c6afdfaec8bdcd7d05cd89fc4ef;
        tau[
            7
        ] = 0x33ebf2408bbe683a2516b6e3904d95f6a99da08c27843d425bb3e781b407f812;
        tau[
            8
        ] = 0x03b2369449d816527fe9f0ec97e4971a65a35f89762ae71610f06096337ea9f2;
        tau[
            9
        ] = 0x38ca25021f2193df59c755dcebe90a5efb52e97c0440597915d022e9a59357bd;
        tau[
            10
        ] = 0x240032a20ecb27257f7334b3f538d836f40783e9709b879bd5523f789aad0a63;
        tau[
            11
        ] = 0x364f7a4b101385305529e5d5237cb71e69950f2b4ed7b4f0b160b1aa3ac71c9a;
        tau[
            12
        ] = 0x3ffacadcc0e723b1fa45c1ad1b30612dc31924e6027171f0a5da6d8963671c5a;
        tau[
            13
        ] = 0x25ad865935043775d676da736cc400404b1060585df1386dd4f560de4c4680bc;
    ...
    function testSecondaryVerificationStep4SubStep2() public pure {
        ...
        tau[
            0
        ] = 0x009c590b21fa438a0f41c61f879bde904d64caa038b18e804a5b45d294334b1e;
        tau[
            1
        ] = 0x3d751f5428fbcf26b2ae69067c7fd14af5c1565070f12c8444ec6682ada61091;
        tau[
            2
        ] = 0x3800b5d1d3dfba0d2299f91c1913e08322441751e5a16fac0221e9f272abc0e0;
        tau[
            3
        ] = 0x2b1fbf9f6d235d75e616c78a1fe7896bb7617c549d48e89bca5d543a861a086b;
        tau[
            4
        ] = 0x097721fcef4ac39120d7370ac44f7aa376fd57491abff8b27721f38213c6c8ca;
        tau[
            5
        ] = 0x02b260afeb7e57bd25dee31120f7d0255e38cebe651348834ec9caab97dd2626;
        tau[
            6
        ] = 0x28c59e7e0901255f1c24bf1e3c956b5912d9c175adbaa4c24f17d9e4264ddd1a;
        tau[
            7
        ] = 0x2d22f3f087ed7343f0311a2b4619381d4528d3f3854a592aa976947ed4d21b43;
        tau[
            8
        ] = 0x0f527dd8578b1c985a782c72705080e78e343d4a51ca822f6d6f9bae4b9f3a34;
        tau[
            9
        ] = 0x0a5a266eeb0f6f4beb2d7909275088b64d909546e10d6fd110156b3bcaac4200;
        tau[
            10
        ] = 0x06b0a4c1b0c64419bbd52d64c97eba76fcda7a5d908cd0f09fe64df7e093731d;
        tau[
            11
        ] = 0x38ec3c68941ff11895c19b3fb11fdacca1bf720c182f01143022ef33065c19e3;
        tau[
            12
        ] = 0x081053b801dc7593cc709d028fa2171fd1b1fb7edc1a5f69acde08b43e89aeb6;
        tau[
            13
        ] = 0x0f33d679b3f3c36b6c01e821c23a71c1ff6f68cdc9b54d2bca469a60279bd3b0;
    ...
    function testNontrivialPrimaryFolding() public {
        ...
        NIFSPallas.RelaxedR1CSInstance memory result = NIFSPallas.verify(
            ...
            S_digest,
            NIFSPallas.RelaxedR1CSInstance(
                Pallas.decompress(r_W),
                Pallas.decompress(r_E),
                r_X,
                r_u
            ),
        ...
        expected_X[
            0
        ] = 0x2e56d20a56a66f2ba12798f718d7d3071f18e03da5d4cac52190ba09ae72f46a;
        expected_X[
            1
        ] = 0x2875f52ba1a60c5b478f684b058d0e2bf2ce904bd0a377ce38699d1a2aa69fad;
    ...
    function testNontrivialSecondaryFolding() public {
        ...
        NIFSVesta.RelaxedR1CSInstance memory result = NIFSVesta.verify(
            NIFSVesta.NIFS(nifs),
            S_digest,
            NIFSVesta.RelaxedR1CSInstance(
                Vesta.decompress(r_W),
                Vesta.decompress(r_E),
                r_X,
                r_u
            ),
        ...
        expected_X[
            0
        ] = 0x32d8d912584abe410b9c9c56cc9efdb0261ed5a636e0fc823bd5b427cf9fcbee;
        expected_X[
            1
        ] = 0x25b86df67043654b4f2becbaf1ea152688dfeffdb1de89cdf0164c59b0330198;
    ...
    function testSumcheckPrimary() public {
        ...
        KeccakTranscriptLib.KeccakTranscript
            memory transcript = KeccakTranscriptLib.instantiate(input);
        ...
        for (uint256 idx = 0; idx < 14; idx++) {
            (transcript, ) = KeccakTranscriptLib.squeeze(
                transcript,
                curve,
                t_label
            );
        ...
        PolyLib.SumcheckProof memory outer_proof = SumcheckData
            .returnPrimaryOuterData();

        uint256 claim_final;
        uint256[] memory r_x = new uint256[](14);

        (claim_final, r_x, transcript) = PrimarySumcheck.verify(
            outer_proof,
            0,
            14,
            3,
        ...
        assertEq(
            claim_final,
            0x346b738474d5b2cda8c002566f1a7004d06cab6b467303a2b7c4b04eaa6df733
        );
    ...
    function testSumcheckSecondary() public {
        ...
        PolyLib.SumcheckProof memory outer_proof = SumcheckData
            .returnSecondaryOuterData();

        uint256 claim_final;
        uint256[] memory r_x = new uint256[](14);

        (claim_final, r_x, transcript) = SecondarySumcheck.verify(
            outer_proof,
            0,
            14,
            3,
        ...
        assertEq(
            claim_final,
            0x157e00e739ad0d53d95e24c8ec0e97081a1f94bb9a4e94a4d198c5533aebc28b
        );
        assertEq(r_x, r_x_result);
    }
}
