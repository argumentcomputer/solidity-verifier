...
contract PpSpartanStep3Computations is Test {
    ...
    function loadSumcheckProof() private pure returns (SumcheckUtilities.SumcheckProof memory) {
        ...
        )
    {
        ...
        //uint256 claim = mulmod(coeffs[9], u_expected.e, Pallas.P_MOD);

        //SumcheckUtilities.SumcheckProof memory sumcheckProof = loadSumcheckProof();
