...
contract FieldLibraryTest is Test {
    ...
    function testSqrt() public view {
        ...
        */
        ...
        assert(
            (Field.sqrt(4958723045, mediumP) == 34190259867)
                || (Field.sqrt(4958723045, mediumP) == mediumP - 34190259867)
        );
        assert(
            (Field.sqrt(619100439513669, mediumP) == 721501758733)
                || (Field.sqrt(619100439513669, mediumP) == mediumP - 721501758733)
        );

        assert(
            (
                Field.sqrt(39192938138472398475092837459827349058720398457082340503458, Pallas.P_MOD)
                    == 6952326682511089053505497910269311565103218810361727881723961806337596520691
            )
                || (
                    Field.sqrt(39192938138472398475092837459827349058720398457082340503458, Pallas.P_MOD)
                        == Pallas.P_MOD - 6952326682511089053505497910269311565103218810361727881723961806337596520691
                )
        );
        assert(
            (
                Field.sqrt(8234882384828389199345394599345003450304929342349912032349, Vesta.P_MOD)
                    == 12180706984407879127889907639794534706595779502336066753700348335280986255802
            )
                || (
                    Field.sqrt(8234882384828389199345394599345003450304929342349912032349, Vesta.P_MOD)
                        == Vesta.P_MOD - 12180706984407879127889907639794534706595779502336066753700348335280986255802
                )
        );
    }
}
