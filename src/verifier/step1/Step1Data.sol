...
function get_r_u_primary_X() public returns (uint256[] memory) {
...
function get_l_u_primary_X() public returns (uint256[] memory) {
...
function get_r_u_secondary_X() public returns (uint256[] memory) {
...
function get_l_u_secondary_X() public returns (uint256[] memory) {
