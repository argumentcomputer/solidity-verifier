...
primary_data_function_def += "function returnPrimaryData() public pure returns (uint256, uint256[] memory, uint256, uint256, uint256[] memory, uint256, uint256, uint256[] memory) {\n"
...
secondary_data_function_def += "function returnSecondaryData() public pure returns (uint256, uint256[] memory, uint256, uint256, uint256[] memory, uint256, uint256, uint256[] memory) {\n"
