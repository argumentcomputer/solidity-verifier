...
contract EqEvaluationTest is Test {
    function testEqEvaluationPrimary1() public {
        ...
        uint256 tauBoundRx = EqPolynomialLib.evaluate(tau, r_x, Vesta.P_MOD, Vesta.negateBase);
    ...
    function testEqEvaluationPrimary2() public {
        ...
        uint256 rz_rx = EqPolynomialLib.evaluate(r_z, r_x, Vesta.P_MOD, Vesta.negateBase);
    ...
    function testEqEvaluationPrimary3() public {
        ...
        uint256 rz_ry = EqPolynomialLib.evaluate(r_z, r_y, Vesta.P_MOD, Vesta.negateBase);
    ...
    function testEqEvaluationSecondary1() public {
        ...
        uint256 tauBoundRx = EqPolynomialLib.evaluate(tau, r_x, Pallas.P_MOD, Pallas.negateBase);
    ...
    function testEqEvaluationSecondary2() public {
        ...
        uint256 rz_ry = EqPolynomialLib.evaluate(r_z, r_y, Pallas.P_MOD, Pallas.negateBase);
    ...
    function testEqEvaluationSecondary3() public {
        ...
        uint256 rz_rx = EqPolynomialLib.evaluate(r_z, r_x, Pallas.P_MOD, Pallas.negateBase);
    ...
    function testEvalsSecondary1() public {
        ...
        uint256[] memory evals = EqPolynomialLib.evals(tau, Vesta.P_MOD, Vesta.negateBase);
    ...
    function testVectorEvalsFromMultiEvaluation1() public {
        ...
        uint256[] memory T_x = EqPolynomialLib.evals(r_x, Pallas.P_MOD, Pallas.negateBase);
    ...
    function testVectorEvalsFromMultiEvaluation2() public {
        ...
        uint256[] memory T_y = EqPolynomialLib.evals(r_y, Pallas.P_MOD, Pallas.negateBase);
